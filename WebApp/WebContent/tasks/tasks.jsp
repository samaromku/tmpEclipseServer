...
<!-- 
<form class="sort_task">
	<div class="inForm">
	<select class="select-control" id="status_id" name="status">
    ...
    <select class="select-control" id="address_id" name="status">
		<option value="all_statuses">Все адреса</option>
...
-->
<p class="tasks_count">Количество активных заявок:${tasks.size()}</p>

<h1 class="title">Список заявок для <c:out value="${userLogin}"/></h1>
<div class="clear"></div>
...
<thead>
	<tr>
		...
		<th data-date-format="ddmmyyyy">Выполнить до</th>
		<th class="col-ms-1">Тип</th>
		<th class="col-ms-1">Исполнитель</th>
		<th class="col-ms-1">Статус</th>
		<th class="col-ms-3">Абонент</th>
		<th class="col-ms-1" style="min-width:90px;" data-date-format="ddmmyyyy">Дата создания</th>
